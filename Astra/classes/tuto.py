...
######### TEXTE INIT ###################
        ...
        self.text06 = "Les boucliers vous protègeront, prenez-les dès que possible !"
...
############# ENEMY INIT ##############################
        ...
        self.enemyTuto = None
        self.enemyDeath_tuto_event = pygame.USEREVENT +300
#######################################################
...
#########################################################
    ...
    def handling_events(self):
        ...
        #event d'apparition d'un ennemi
            ...
            if not(self.enemyTuto in self.enemy) :
                pygame.time.set_timer(self.enemyDeath_tuto_event, 2000)
                print("azefzaegvbzaev")
            
            if event.type == self.enemyDeath_tuto_event :
                pygame.time.set_timer(self.enemyDeath_tuto_event, 0)
        ...
        #event d'apparition des obstacles
            if event.type == self.obstacle_tuto_event :
                ...
                # pygame.time.set_timer(self.obstacle_tuto_event, 500)
