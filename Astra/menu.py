...
class menu : 
    ...
    def mainMenu(self):
        bg = pygame.image.load("img/mainmenu.png")
        while True:
            ...
            playButton = Button(playButtonIMG, 450, 370)
            if playButton.checkingInput(menuMousePos):
                ...
                playButton = Button(playButtonIMGHover, 450, 370) #décallage ?
            ...
            optionsButton = Button(optionsButtonIMG, 400, 470)
            if optionsButton.checkingInput(menuMousePos):
                ...
                optionsButton = Button(optionsButtonIMGHover, 400, 470)
            ...
            showCreditsButton = Button(showCreditsButtonIMG, 400, 570)
            if showCreditsButton.checkingInput(menuMousePos):
                ...
                showCreditsButton = Button(showCreditsButtonIMGHover, 400, 570)
            ...
            quitButton = Button(quitButtonIMG, 400, 670)
            if quitButton.checkingInput(menuMousePos):
                ...
                quitButton = Button(quitButtonIMGHover, 400, 670)
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if playButton.checkingInput(menuMousePos):
                        ...
                        pygame.font.init()
                        mixer.music.load("song/8bit.ogg")
                        mixer.music.play(-1)
                        tuto = Tuto(screen)
                        tuto.run()
                        pygame.quit()
